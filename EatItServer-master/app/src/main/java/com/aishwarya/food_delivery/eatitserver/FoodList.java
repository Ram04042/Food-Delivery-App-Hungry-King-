...
import com.aishwarya.food_delivery.eatitserver.Model.Food;
import com.aishwarya.food_delivery.eatitserver.ViewHolder.FoodViewHolder;
...
public class FoodList extends AppCompatActivity {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (newFood != null){
                    ...
                    Snackbar.make(food_list_layout, "Fresh Food "+ newFood.getName()+"Added", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    private void showUpdateFoodDialog(final String key, final Food item) {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(FoodList.this);
        alertDialog.setTitle("Edit the food Contacts");
