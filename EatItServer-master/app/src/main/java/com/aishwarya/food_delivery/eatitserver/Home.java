...
import com.aishwarya.food_delivery.eatitserver.Model.Category;
import com.aishwarya.food_delivery.eatitserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int i) {
                ...
                if (newCategory != null){
                    ...
                    Snackbar.make(drawer, "New Category "+ newCategory.getName()+"Added", Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Common.PICK_IMAGE_REQUEST && resultCode == RESULT_OK
            ...
            btnSelect.setText("Picture Selected");
        }
    }
    ...
    private void chooseImage() {
        ...
        startActivityForResult(Intent.createChooser(intent,"Choose Picture"),Common.PICK_IMAGE_REQUEST);
    }
    ...
    private void deleteCategory(String key) {
        ...
        Toast.makeText(this, "Items in Delete!!!", Toast.LENGTH_SHORT);
    }
